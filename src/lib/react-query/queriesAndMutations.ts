  ...
  export const useSavePost = () => {
    ...
    return useMutation({
        ...
        mutationFn: ({ postId, userId }: { postId: string; userId: string }) => {
            // Log postId and userId to see if they are being passed correctly
            console.log("useSavePost -> postId:", postId);
            console.log("useSavePost -> userId:", userId);
  ...
  export const useDeletePost = () => {
   ...
   export const useGetPosts = () => {
    return useInfiniteQuery({
      ...
      queryFn: getInfinitePosts as any, // Type casting if necessary
      ...
      // Add initialPageParam to comply with TypeScript
      initialPageParam: undefined, // or set it to a value if needed
    });
  };
